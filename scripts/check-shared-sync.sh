...
DESTS="$ROOT/plugins/builder/lib/common.sh $ROOT/plugins/explorer/lib/common.sh $ROOT/plugins/pipeline/lib/common.sh $ROOT/plugins/auditor/lib/common.sh $ROOT/plugins/reviewer/lib/common.sh $ROOT/plugins/ops/lib/common.sh"
